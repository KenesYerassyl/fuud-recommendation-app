...
struct API {
    ...
    static func getRestaurants(completion: @escaping ([Restaurant]?) -> Void) {
        ...
        let apikey = "HPBWDt_Fdw7qSh03NLyj6eWzKZUAwvrwDezxfQOtrzeggzCVI6k_ZxyclXvLrdP4UgRjYvql5Qu7su0M8ieIH0AMM38y5kIb-1N7Rlq-6JmMGbHQ8JBWBXIPsvtfZnYx"
...
//        print("Current user city is \(String(describing: user_city_input))")
        ...
        let headers = [
            "x-rapidapi-key": "e46d01bfc3mshc34dbe5135aa5d3p14bb8ajsn43e2f0bfe1f0",
            "x-rapidapi-host": "wft-geo-db.p.rapidapi.com"
        ]
